...
CONFIG = {
    ...
    'motor_f': [Besiege.GetBlock('SPINNING 1')],
    'motor_b': [Besiege.GetBlock('SPINNING 2')],
    'motor_r': [Besiege.GetBlock('SPINNING 3')],
    'motor_l': [Besiege.GetBlock('SPINNING 4')],
