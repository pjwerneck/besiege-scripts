...
CONFIG = {
    ...
    'motor_u': [Besiege.GetBlock('SPINNING 1')],
    'motor_d': [Besiege.GetBlock('SPINNING 2')],

    'motor_pitch': [Besiege.GetBlock('STEERING 3'), Besiege.GetBlock('STEERING 4')],
    'motor_roll': [Besiege.GetBlock('STEERING 1'), Besiege.GetBlock('STEERING 2')],
